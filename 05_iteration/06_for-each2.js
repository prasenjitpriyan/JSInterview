...
// const newNumbs = myNumbs.filter((num) => num > 4);
// console.log(newNumbs);

// //return must be added in filter if scoped is opened
// const Numbs = myNumbs.filter((num) => {
//     return num > 4
// });
// console.log(Numbs);

// //For...each use in above example
// const numbers = [];
// myNumbs.forEach((num) => {
//     if (num > 4) {
//         numbers.push(num)
...
let userBooks = books.filter((bk) => bk.pages > 310)

userBooks = books.filter((bk) => {
    return bk.published >= 2015 && bk.publisher === "Apress"
})
